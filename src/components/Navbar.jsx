...
// const Navbar = () => {
//     const { isCartOpen, setIsCartOpen, loadCart } = useCart();
...
//                             <div className="flex items-center gap-x-2 cursor-pointer p-2 rounded-full hover:bg-blue-50 transition-colors" onClick={handleOpenCart}>
...
//                         <li className={`${linkClasses} ${linkAfter}`} onClick={() => navigate("/deals")}>Deals</li>
...
//                             <li className="p-2 rounded-lg hover:bg-blue-50 transition-colors" onClick={() => { navigate('/deals'); setIsMenuOpen(false); }}>Deals</li>
...
//                             <button onClick={handleOpenCart} className="w-full flex items-center justify-center gap-x-3 border border-blue-600 text-blue-600 font-bold py-3 rounded-full hover:bg-blue-50 transition-all duration-300">
//                                 <ShoppingBag size={20} />
//                                 <span>Cart</span>
//                             </button>
//                         </div>
